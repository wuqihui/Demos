...
namespace ContosoUniversity.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public ActionResult Create(Department department)
        {
            ...
            ViewBag.InstructorID = new SelectList(db.Instructors, "InstructorID", "LastName", department.PersonID);
            return View(department);
        }
        ...
        private void ValidateOneAdministratorAssignmentPerInstructor(Department department)
        {
            if (department.PersonID != null)
            {
                var duplicateDepartment =
                    db.Departments.Include("Administrator").Where(d => d.PersonID == department.PersonID)
                        .AsNoTracking().FirstOrDefault();

                if (duplicateDepartment != null && duplicateDepartment.DepartmentID != department.DepartmentID)
                {
                    var errorMessage = string.Format("Instructor {0} {1} is already administrator of the {2} department.",
